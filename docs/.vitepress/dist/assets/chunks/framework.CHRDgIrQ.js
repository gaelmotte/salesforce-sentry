...
function xu(e) {
  ...
  if (((t = decodeURIComponent(t)), (t = t.replace(/\/$/, "/index")), pe)) {
    t = Jr(t.slice(1).replace(/\//g, "_") || "index") + ".md";
...
const hf = "/assets/SentrySDK.NXYb7eZL.png",
  pf = "/assets/existingFlow.CqEzLSs7.png",
  gf = "/assets/addElement.yw9O7YtP.png",
  mf = "/assets/configureElement.DK-81Dnv.png",
  vf = "/assets/custometalist.qiN-CYnA.png",
  yf = "/assets/configSample.BC_RhS4m.png",
  _f = "/assets/payload.sLeIMxxS.png";
export {
  xl as $,
  au as A,
  vu as B,
